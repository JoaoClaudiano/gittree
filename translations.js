...
const translations = {
    en: {
        ...
        metricTotalFolders: "Total Folders",
        ...
        statusClipboardError: "Could not access clipboard",
        confirmClearCache: "Clear all cache?",
        statusNoTree: "No tree to copy",
        statusEmptyTree: "Empty tree",
        statusCopyError: "Copy error",
        statusCorrecting: "Correcting to:",
        statusFetching: "Fetching",
        statusProcessingItems: "Processing {n} items...",
        ...
        privacyIntroNotice: "In summary: we don't require registration, we don't store analyzed code, and we don't sell personal data.",
        privacySection1Title: "1. Legal Basis and Compliance",
        privacySection1Intro: "Data processing by GitTree complies with:",
        privacySection1List: '<li class="list-item">General Data Protection Law – LGPD (Law No. 13,709/2018)</li><li class="list-item">General Data Protection Regulation of the European Union (GDPR)</li><li class="list-item">Google AdSense and Google Consent Mode Policies</li>',
        privacySection2Title: "2. Information Collected",
        privacySection2P1: "GitTree <strong>does not collect sensitive personal data</strong> and <strong>does not require user identification</strong>.",
        privacySection2P2: "Public GitHub repository URLs may be voluntarily provided for analysis purposes. The analyzed content <strong>is not stored, indexed, or redistributed</strong>.",
        privacySection2P3: "Automatically, anonymous technical information may be collected, including:",
        privacySection2List: '<li class="list-item">Anonymized IP address</li><li class="list-item">Browser type and operating system</li><li class="list-item">Pages visited and browsing time</li><li class="list-item">Approximate location (country or region)</li>',
        privacySection3Title: "3. Cookies, Advertising, and CMP",
        privacySection3P1: "We use cookies and similar technologies to ensure the operation, security, statistical analysis, and monetization of the site.",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – usage and performance analysis</li><li class="list-item"><strong>Google AdSense</strong> – ad display</li>',
        privacySection3P2: "Google and its partners may use cookies for personalization or ad measurement, according to user consent.",
        privacySection3P3: "Consent management is handled through a <strong>Consent Management Platform (CMP)</strong>, allowing users to accept, reject, or customize cookie usage, in compliance with LGPD and GDPR.",
        privacySection4Title: "4. Data Sharing",
        privacySection4P1: "GitTree <strong>does not sell personal data</strong>.",
        privacySection4P2: "Anonymous technical information may be shared with service providers strictly for:",
        privacySection4List: '<li class="list-item">Audience measurement</li><li class="list-item">Advertising display</li><li class="list-item">Security and abuse prevention</li>',
        privacySection4P3: "These third parties process data according to their own policies and legal obligations.",
        privacySection5Title: "5. User Rights",
        privacySection5P1: "Under applicable law, you have the right to:",
        privacySection5List: '<li class="list-item">Request confirmation about data processing</li><li class="list-item">Revoke consents at any time</li><li class="list-item">Request additional information about cookies and tracking</li>',
        privacySection5P2: "Since we do not maintain identifiable personal databases, requests typically apply to third-party services.",
        privacySection6Title: "6. Policy Updates",
        privacySection6P1: "This Privacy Policy may be changed at any time for legal compliance or technical improvements. The current version will always be available on this page. Current version: January 2026",
        privacySection7Title: "7. Contact",
        privacySection7P1: "For questions related to privacy and data protection:",
        ...
        termsIntroNotice: "GitTree is an auxiliary analysis tool. It does not replace human review, technical audit, or professional judgment.",
        termsSection1Title: "1. Service Description",
        termsSection1P1: "GitTree is an online tool that performs automated analyses of public GitHub repositories, offering visualizations, metrics, and auxiliary interpretations about source code.",
        termsSection1P2: "The analyses are generated automatically and <strong>do not constitute guarantees of quality, security, or compliance</strong> of the analyzed code.",
        termsSection2Title: "2. Acceptable Use",
        termsSection2P1: "By using GitTree, you agree to:",
        termsSection2List: '<li class="list-item">Provide only URLs of public repositories or repositories you own</li><li class="list-item">Use the tool for lawful and ethical purposes</li><li class="list-item">Not attempt to exploit vulnerabilities, overload, or compromise the service</li>',
        termsSection2P2: "Use of the tool for illegal, abusive, or third-party rights-violating activities is prohibited.",
        termsSection3Title: "3. Intellectual Property",
        termsSection3P1: "GitTree does not claim any rights over the analyzed code.",
        termsSection3P2: "All original platform content (interface, visual identity, texts, and service logic) is protected by copyright and belongs to its respective owners.",
        termsSection3P3: "Use of the service does not grant the user any right to commercially exploit the platform.",
        termsSection4Title: "4. Limitation of Liability",
        termsSection4P1: 'GitTree is provided <strong>"as is"</strong>, without express or implied warranties.',
        termsSection4P2: "We are not responsible for:",
        termsSection4List: '<li class="list-item">Errors, omissions, or inaccuracies in analyses</li><li class="list-item">Decisions made based on the information presented</li><li class="list-item">Direct or indirect damages arising from use of the tool</li>',
        termsSection4P3: "The user is solely responsible for verifying, interpreting, and applying the results obtained.",
        termsSection5Title: "5. Service Availability",
        termsSection5P1: "GitTree may be altered, suspended, or discontinued, in whole or in part, at any time without prior notice.",
        termsSection5P2: "We do not guarantee continuous or error-free availability.",
        termsSection6Title: "6. Privacy and Data",
        termsSection6P1: 'Data processing follows the provisions of the <a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">Privacy Policy</a>, which is an integral part of these Terms.',
        termsSection6P2: "By using the site, you acknowledge the use of cookies, analytics tools, and advertising, as informed in the corresponding policy.",
        termsSection7Title: "7. Changes to Terms",
        termsSection7P1: "These Terms of Use may be modified at any time for legal compliance or service evolution.",
        termsSection7P2: "Continued use after changes implies acceptance of the updated version.",
        termsSection8Title: "8. Contact",
        termsSection8P1: "For questions about these Terms of Use, please contact:",
    ...
    pt: {
        ...
        metricTotalFolders: "Total de Pastas",
        ...
        statusClipboardError: "Não foi possível acessar a área de transferência",
        confirmClearCache: "Limpar todo o cache?",
        statusNoTree: "Nenhuma árvore para copiar",
        statusEmptyTree: "Árvore vazia",
        statusCopyError: "Erro ao copiar",
        statusCorrecting: "Corrigindo para:",
        statusFetching: "Buscando",
        statusProcessingItems: "Processando {n} itens...",
        ...
        privacyIntroNotice: "Em resumo: não exigimos cadastro, não armazenamos código analisado e não vendemos dados pessoais.",
        privacySection1Title: "1. Base Legal e Conformidade",
        privacySection1Intro: "O tratamento de dados realizado pelo GitTree observa:",
        privacySection1List: '<li class="list-item">Lei Geral de Proteção de Dados – LGPD (Lei nº 13.709/2018)</li><li class="list-item">Regulamento Geral de Proteção de Dados da União Europeia (GDPR)</li><li class="list-item">Políticas do Google AdSense e Google Consent Mode</li>',
        privacySection2Title: "2. Informações Coletadas",
        privacySection2P1: "O GitTree <strong>não coleta dados pessoais sensíveis</strong> e <strong>não exige identificação do usuário</strong>.",
        privacySection2P2: "URLs públicas de repositórios do GitHub podem ser fornecidas voluntariamente para fins de análise pontual. O conteúdo analisado <strong>não é armazenado, indexado ou redistribuído</strong>.",
        privacySection2P3: "De forma automática, podem ser coletadas informações técnicas e anônimas, incluindo:",
        privacySection2List: '<li class="list-item">Endereço IP anonimizado</li><li class="list-item">Tipo de navegador e sistema operacional</li><li class="list-item">Páginas acessadas e tempo de navegação</li><li class="list-item">Localização aproximada (país ou região)</li>',
        privacySection3Title: "3. Cookies, Publicidade e CMP",
        privacySection3P1: "Utilizamos cookies e tecnologias semelhantes para garantir o funcionamento, segurança, análise estatística e monetização do site.",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – análise de uso e desempenho</li><li class="list-item"><strong>Google AdSense</strong> – exibição de anúncios</li>',
        privacySection3P2: "O Google e seus parceiros podem utilizar cookies para personalização ou medição de anúncios, conforme consentimento do usuário.",
        privacySection3P3: "O gerenciamento de consentimento é realizado por meio de uma <strong>Plataforma de Gerenciamento de Consentimento (CMP)</strong>, permitindo aceitar, recusar ou personalizar o uso de cookies, em conformidade com LGPD e GDPR.",
        privacySection4Title: "4. Compartilhamento de Dados",
        privacySection4P1: "O GitTree <strong>não comercializa dados pessoais</strong>.",
        privacySection4P2: "Informações técnicas e anônimas podem ser compartilhadas com prestadores de serviço estritamente para:",
        privacySection4List: '<li class="list-item">Medição de audiência</li><li class="list-item">Exibição de publicidade</li><li class="list-item">Segurança e prevenção de abuso</li>',
        privacySection4P3: "Esses terceiros processam dados conforme suas próprias políticas e obrigações legais.",
        privacySection5Title: "5. Direitos do Usuário",
        privacySection5P1: "Nos termos da legislação aplicável, você tem o direito de:",
        privacySection5List: '<li class="list-item">Solicitar confirmação sobre tratamento de dados</li><li class="list-item">Revogar consentimentos a qualquer momento</li><li class="list-item">Solicitar informações adicionais sobre cookies e rastreamento</li>',
        privacySection5P2: "Como não mantemos banco de dados pessoais identificáveis, as solicitações normalmente se aplicam a serviços de terceiros.",
        privacySection6Title: "6. Atualizações desta Política",
        privacySection6P1: "Esta Política de Privacidade pode ser alterada a qualquer momento, visando adequação legal ou melhorias técnicas. A versão vigente estará sempre disponível nesta página. Versão atual: Janeiro - 2026",
        privacySection7Title: "7. Contato",
        privacySection7P1: "Para dúvidas relacionadas à privacidade e proteção de dados:",
        ...
        termsIntroNotice: "O GitTree é uma ferramenta de análise auxiliar. Não substitui revisão humana, auditoria técnica ou julgamento profissional.",
        termsSection1Title: "1. Descrição do Serviço",
        termsSection1P1: "O GitTree é uma ferramenta online que realiza análises automatizadas de repositórios públicos do GitHub, com o objetivo de oferecer visualizações, métricas e interpretações auxiliares sobre código-fonte.",
        termsSection1P2: "As análises são geradas de forma automatizada e <strong>não constituem garantia de qualidade, segurança ou conformidade</strong> do código analisado.",
        termsSection2Title: "2. Uso Aceitável",
        termsSection2P1: "Ao utilizar o GitTree, você se compromete a:",
        termsSection2List: '<li class="list-item">Fornecer apenas URLs de repositórios públicos ou de sua titularidade</li><li class="list-item">Utilizar a ferramenta para fins lícitos e éticos</li><li class="list-item">Não tentar explorar falhas, sobrecarregar ou comprometer o serviço</li>',
        termsSection2P2: "É vedado o uso da ferramenta para atividades ilegais, abusivas ou que violem direitos de terceiros.",
        termsSection3Title: "3. Propriedade Intelectual",
        termsSection3P1: "O GitTree não reivindica qualquer direito sobre o código analisado.",
        termsSection3P2: "Todo o conteúdo original da plataforma (interface, identidade visual, textos e lógica do serviço) é protegido por direitos autorais e pertence aos seus respectivos titulares.",
        termsSection3P3: "O uso do serviço não concede ao usuário qualquer direito de exploração comercial da plataforma.",
        termsSection4Title: "4. Limitação de Responsabilidade",
        termsSection4P1: 'O GitTree é fornecido <strong>"no estado em que se encontra"</strong>, sem garantias expressas ou implícitas.',
        termsSection4P2: "Não nos responsabilizamos por:",
        termsSection4List: '<li class="list-item">Erros, omissões ou imprecisões nas análises</li><li class="list-item">Decisões tomadas com base nas informações apresentadas</li><li class="list-item">Danos diretos ou indiretos decorrentes do uso da ferramenta</li>',
        termsSection4P3: "O usuário é o único responsável pela verificação, interpretação e aplicação dos resultados obtidos.",
        termsSection5Title: "5. Disponibilidade do Serviço",
        termsSection5P1: "O GitTree pode ser alterado, suspenso ou descontinuado, total ou parcialmente, a qualquer momento, sem aviso prévio.",
        termsSection5P2: "Não garantimos disponibilidade contínua ou livre de falhas.",
        termsSection6Title: "6. Privacidade e Dados",
        termsSection6P1: 'O tratamento de dados segue o disposto na <a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">Política de Privacidade</a>, parte integrante destes Termos.',
        termsSection6P2: "Ao utilizar o site, você declara estar ciente do uso de cookies, ferramentas de análise e publicidade, conforme informado na política correspondente.",
        termsSection7Title: "7. Alterações nos Termos",
        termsSection7P1: "Estes Termos de Uso podem ser modificados a qualquer momento, visando adequação legal ou evolução do serviço.",
        termsSection7P2: "A continuidade do uso após alterações implica concordância com a versão atualizada.",
        termsSection8Title: "8. Contato",
        termsSection8P1: "Em caso de dúvidas sobre estes Termos de Uso, entre em contato:",
    ...
    es: {
        ...
        metricTotalFolders: "Total de Carpetas",
        ...
        statusClipboardError: "No se pudo acceder al portapapeles",
        confirmClearCache: "¿Limpiar todo el caché?",
        statusNoTree: "No hay árbol para copiar",
        statusEmptyTree: "Árbol vacío",
        statusCopyError: "Error al copiar",
        statusCorrecting: "Corrigiendo a:",
        statusFetching: "Buscando",
        statusProcessingItems: "Procesando {n} elementos...",
        ...
        privacyIntroNotice: "En resumen: no requerimos registro, no almacenamos código analizado y no vendemos datos personales.",
        privacySection1Title: "1. Base Legal y Cumplimiento",
        privacySection1Intro: "El tratamiento de datos por GitTree cumple con:",
        privacySection1List: '<li class="list-item">Ley General de Protección de Datos – LGPD (Ley nº 13.709/2018)</li><li class="list-item">Reglamento General de Protección de Datos de la Unión Europea (GDPR)</li><li class="list-item">Políticas de Google AdSense y Google Consent Mode</li>',
        privacySection2Title: "2. Información Recopilada",
        privacySection2P1: "GitTree <strong>no recopila datos personales sensibles</strong> y <strong>no requiere identificación del usuario</strong>.",
        privacySection2P2: "Las URLs públicas de repositorios de GitHub pueden ser proporcionadas voluntariamente para análisis. El contenido analizado <strong>no se almacena, indexa ni redistribuye</strong>.",
        privacySection2P3: "De forma automática, se puede recopilar información técnica anónima, incluyendo:",
        privacySection2List: '<li class="list-item">Dirección IP anonimizada</li><li class="list-item">Tipo de navegador y sistema operativo</li><li class="list-item">Páginas visitadas y tiempo de navegación</li><li class="list-item">Ubicación aproximada (país o región)</li>',
        privacySection3Title: "3. Cookies, Publicidad y CMP",
        privacySection3P1: "Utilizamos cookies y tecnologías similares para garantizar el funcionamiento, seguridad, análisis estadístico y monetización del sitio.",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – análisis de uso y rendimiento</li><li class="list-item"><strong>Google AdSense</strong> – visualización de anuncios</li>',
        privacySection3P2: "Google y sus socios pueden utilizar cookies para personalización o medición de anuncios, según el consentimiento del usuario.",
        privacySection3P3: "La gestión del consentimiento se realiza mediante una <strong>Plataforma de Gestión de Consentimiento (CMP)</strong>, que permite aceptar, rechazar o personalizar el uso de cookies, en cumplimiento con LGPD y GDPR.",
        privacySection4Title: "4. Compartición de Datos",
        privacySection4P1: "GitTree <strong>no comercializa datos personales</strong>.",
        privacySection4P2: "La información técnica anónima puede compartirse con proveedores de servicios estrictamente para:",
        privacySection4List: '<li class="list-item">Medición de audiencia</li><li class="list-item">Visualización de publicidad</li><li class="list-item">Seguridad y prevención de abusos</li>',
        privacySection4P3: "Estos terceros procesan datos conforme a sus propias políticas y obligaciones legales.",
        privacySection5Title: "5. Derechos del Usuario",
        privacySection5P1: "Según la legislación aplicable, tiene derecho a:",
        privacySection5List: '<li class="list-item">Solicitar confirmación sobre el tratamiento de datos</li><li class="list-item">Revocar consentimientos en cualquier momento</li><li class="list-item">Solicitar información adicional sobre cookies y seguimiento</li>',
        privacySection5P2: "Como no mantenemos bases de datos personales identificables, las solicitudes normalmente se aplican a servicios de terceros.",
        privacySection6Title: "6. Actualizaciones de esta Política",
        privacySection6P1: "Esta Política de Privacidad puede modificarse en cualquier momento para adecuación legal o mejoras técnicas. La versión vigente siempre estará disponible en esta página. Versión actual: Enero 2026",
        privacySection7Title: "7. Contacto",
        privacySection7P1: "Para preguntas relacionadas con la privacidad y la protección de datos:",
        ...
        termsIntroNotice: "GitTree es una herramienta de análisis auxiliar. No sustituye la revisión humana, auditoría técnica ni el juicio profesional.",
        termsSection1Title: "1. Descripción del Servicio",
        termsSection1P1: "GitTree es una herramienta en línea que realiza análisis automatizados de repositorios públicos de GitHub, con el objetivo de ofrecer visualizaciones, métricas e interpretaciones auxiliares sobre el código fuente.",
        termsSection1P2: "Los análisis se generan de forma automatizada y <strong>no constituyen garantía de calidad, seguridad o conformidad</strong> del código analizado.",
        termsSection2Title: "2. Uso Aceptable",
        termsSection2P1: "Al utilizar GitTree, usted se compromete a:",
        termsSection2List: '<li class="list-item">Proporcionar solo URLs de repositorios públicos o de su propiedad</li><li class="list-item">Usar la herramienta para fines lícitos y éticos</li><li class="list-item">No intentar explotar vulnerabilidades, sobrecargar o comprometer el servicio</li>',
        termsSection2P2: "Está prohibido el uso de la herramienta para actividades ilegales, abusivas o que violen derechos de terceros.",
        termsSection3Title: "3. Propiedad Intelectual",
        termsSection3P1: "GitTree no reclama ningún derecho sobre el código analizado.",
        termsSection3P2: "Todo el contenido original de la plataforma (interfaz, identidad visual, textos y lógica del servicio) está protegido por derechos de autor y pertenece a sus respectivos titulares.",
        termsSection3P3: "El uso del servicio no concede al usuario ningún derecho de explotación comercial de la plataforma.",
        termsSection4Title: "4. Limitación de Responsabilidad",
        termsSection4P1: 'GitTree se proporciona <strong>"tal como está"</strong>, sin garantías expresas ni implícitas.',
        termsSection4P2: "No somos responsables de:",
        termsSection4List: '<li class="list-item">Errores, omisiones o inexactitudes en los análisis</li><li class="list-item">Decisiones tomadas en base a la información presentada</li><li class="list-item">Daños directos o indirectos derivados del uso de la herramienta</li>',
        termsSection4P3: "El usuario es el único responsable de verificar, interpretar y aplicar los resultados obtenidos.",
        termsSection5Title: "5. Disponibilidad del Servicio",
        termsSection5P1: "GitTree puede ser alterado, suspendido o descontinuado, total o parcialmente, en cualquier momento sin previo aviso.",
        termsSection5P2: "No garantizamos disponibilidad continua ni libre de errores.",
        termsSection6Title: "6. Privacidad y Datos",
        termsSection6P1: 'El tratamiento de datos sigue lo dispuesto en la <a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">Política de Privacidad</a>, parte integrante de estos Términos.',
        termsSection6P2: "Al usar el sitio, declara estar al tanto del uso de cookies, herramientas de análisis y publicidad, según se informa en la política correspondiente.",
        termsSection7Title: "7. Cambios en los Términos",
        termsSection7P1: "Estos Términos de Uso pueden modificarse en cualquier momento para adecuación legal o evolución del servicio.",
        termsSection7P2: "La continuación del uso tras los cambios implica aceptación de la versión actualizada.",
        termsSection8Title: "8. Contacto",
        termsSection8P1: "Para preguntas sobre estos Términos de Uso, póngase en contacto:",
    ...
    fr: {
        ...
        metricTotalFolders: "Total des Dossiers",
        ...
        statusClipboardError: "Impossible d'accéder au presse-papiers",
        confirmClearCache: "Vider tout le cache ?",
        statusNoTree: "Pas d'arbre à copier",
        statusEmptyTree: "Arbre vide",
        statusCopyError: "Erreur de copie",
        statusCorrecting: "Correction vers :",
        statusFetching: "Récupération de",
        statusProcessingItems: "Traitement de {n} éléments...",
        ...
        privacyIntroNotice: "En résumé : nous n\'exigeons pas d\'inscription, nous ne stockons pas le code analysé et nous ne vendons pas de données personnelles.",
        privacySection1Title: "1. Base légale et conformité",
        privacySection1Intro: "Le traitement des données par GitTree respecte :",
        privacySection1List: '<li class="list-item">Loi générale sur la protection des données – LGPD (Loi nº 13 709/2018)</li><li class="list-item">Règlement général sur la protection des données de l\'Union européenne (RGPD)</li><li class="list-item">Politiques de Google AdSense et Google Consent Mode</li>',
        privacySection2Title: "2. Informations collectées",
        privacySection2P1: "GitTree <strong>ne collecte pas de données personnelles sensibles</strong> et <strong>ne requiert pas l\'identification de l\'utilisateur</strong>.",
        privacySection2P2: "Les URL publiques de dépôts GitHub peuvent être fournies volontairement à des fins d\'analyse. Le contenu analysé <strong>n\'est pas stocké, indexé ou redistribué</strong>.",
        privacySection2P3: "De manière automatique, des informations techniques et anonymes peuvent être collectées, notamment :",
        privacySection2List: '<li class="list-item">Adresse IP anonymisée</li><li class="list-item">Type de navigateur et système d\'exploitation</li><li class="list-item">Pages visitées et temps de navigation</li><li class="list-item">Localisation approximative (pays ou région)</li>',
        privacySection3Title: "3. Cookies, publicité et CMP",
        privacySection3P1: "Nous utilisons des cookies et des technologies similaires pour garantir le fonctionnement, la sécurité, l\'analyse statistique et la monétisation du site.",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – analyse d\'utilisation et de performance</li><li class="list-item"><strong>Google AdSense</strong> – affichage de publicités</li>',
        privacySection3P2: "Google et ses partenaires peuvent utiliser des cookies pour la personnalisation ou la mesure des publicités, selon le consentement de l\'utilisateur.",
        privacySection3P3: "La gestion du consentement est assurée par une <strong>Plateforme de Gestion du Consentement (CMP)</strong>, permettant d\'accepter, de refuser ou de personnaliser l\'utilisation des cookies, conformément au LGPD et au RGPD.",
        privacySection4Title: "4. Partage des données",
        privacySection4P1: "GitTree <strong>ne commercialise pas les données personnelles</strong>.",
        privacySection4P2: "Les informations techniques anonymes peuvent être partagées avec des prestataires de services strictement pour :",
        privacySection4List: '<li class="list-item">Mesure d\'audience</li><li class="list-item">Affichage de publicités</li><li class="list-item">Sécurité et prévention des abus</li>',
        privacySection4P3: "Ces tiers traitent les données conformément à leurs propres politiques et obligations légales.",
        privacySection5Title: "5. Droits des utilisateurs",
        privacySection5P1: "Conformément à la législation applicable, vous avez le droit de :",
        privacySection5List: '<li class="list-item">Demander une confirmation sur le traitement des données</li><li class="list-item">Révoquer les consentements à tout moment</li><li class="list-item">Demander des informations supplémentaires sur les cookies et le suivi</li>',
        privacySection5P2: "Comme nous ne maintenons pas de bases de données personnelles identifiables, les demandes s\'appliquent généralement aux services tiers.",
        privacySection6Title: "6. Mises à jour de cette politique",
        privacySection6P1: "Cette Politique de Confidentialité peut être modifiée à tout moment pour des raisons de conformité légale ou d\'améliorations techniques. La version en vigueur sera toujours disponible sur cette page. Version actuelle : Janvier 2026",
        privacySection7Title: "7. Contact",
        privacySection7P1: "Pour toute question relative à la confidentialité et à la protection des données :",
        ...
        termsIntroNotice: "GitTree est un outil d\'analyse auxiliaire. Il ne remplace pas la révision humaine, l\'audit technique ou le jugement professionnel.",
        termsSection1Title: "1. Description du service",
        termsSection1P1: "GitTree est un outil en ligne qui effectue des analyses automatisées de dépôts publics GitHub, dans le but d\'offrir des visualisations, des métriques et des interprétations auxiliaires sur le code source.",
        termsSection1P2: "Les analyses sont générées de manière automatisée et <strong>ne constituent pas une garantie de qualité, de sécurité ou de conformité</strong> du code analysé.",
        termsSection2Title: "2. Utilisation acceptable",
        termsSection2P1: "En utilisant GitTree, vous vous engagez à :",
        termsSection2List: '<li class="list-item">Fournir uniquement des URL de dépôts publics ou vous appartenant</li><li class="list-item">Utiliser l\'outil à des fins légales et éthiques</li><li class="list-item">Ne pas tenter d\'exploiter des failles, de surcharger ou de compromettre le service</li>',
        termsSection2P2: "L\'utilisation de l\'outil à des fins illégales, abusives ou portant atteinte aux droits de tiers est interdite.",
        termsSection3Title: "3. Propriété intellectuelle",
        termsSection3P1: "GitTree ne revendique aucun droit sur le code analysé.",
        termsSection3P2: "Tout le contenu original de la plateforme (interface, identité visuelle, textes et logique du service) est protégé par des droits d\'auteur et appartient à ses titulaires respectifs.",
        termsSection3P3: "L\'utilisation du service n\'accorde à l\'utilisateur aucun droit d\'exploitation commerciale de la plateforme.",
        termsSection4Title: "4. Limitation de responsabilité",
        termsSection4P1: 'GitTree est fourni <strong>"tel quel"</strong>, sans garanties expresses ou implicites.',
        termsSection4P2: "Nous ne sommes pas responsables de :",
        termsSection4List: '<li class="list-item">Erreurs, omissions ou inexactitudes dans les analyses</li><li class="list-item">Décisions prises sur la base des informations présentées</li><li class="list-item">Dommages directs ou indirects résultant de l\'utilisation de l\'outil</li>',
        termsSection4P3: "L\'utilisateur est seul responsable de la vérification, de l\'interprétation et de l\'application des résultats obtenus.",
        termsSection5Title: "5. Disponibilité du service",
        termsSection5P1: "GitTree peut être modifié, suspendu ou interrompu, en tout ou partie, à tout moment sans préavis.",
        termsSection5P2: "Nous ne garantissons pas une disponibilité continue ou sans erreur.",
        termsSection6Title: "6. Confidentialité et données",
        termsSection6P1: 'Le traitement des données suit les dispositions de la <a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">Politique de Confidentialité</a>, partie intégrante de ces Conditions.',
        termsSection6P2: "En utilisant le site, vous déclarez être informé de l\'utilisation de cookies, d\'outils d\'analyse et de publicité, tels qu\'indiqués dans la politique correspondante.",
        termsSection7Title: "7. Modifications des conditions",
        termsSection7P1: "Ces Conditions d\'Utilisation peuvent être modifiées à tout moment pour des raisons de conformité légale ou d\'évolution du service.",
        termsSection7P2: "La poursuite de l\'utilisation après les modifications implique l\'acceptation de la version mise à jour.",
        termsSection8Title: "8. Contact",
        termsSection8P1: "Pour toute question sur ces Conditions d\'Utilisation, contactez-nous :",
    ...
    it: {
        ...
        metricSize: "Dimensione",
        metricTypes: "Tipi",
        metricTotalFiles: "File Totali",
        metricTotalFolders: "Cartelle Totali",
        ...
        statusClipboardError: "Impossibile accedere agli appunti",
        confirmClearCache: "Svuotare tutta la cache?",
        statusNoTree: "Nessun albero da copiare",
        statusEmptyTree: "Albero vuoto",
        statusCopyError: "Errore di copia",
        statusCorrecting: "Correzione a:",
        statusFetching: "Recupero di",
        statusProcessingItems: "Elaborazione di {n} elementi...",
        ...
        privacyIntroNotice: "In sintesi: non richiediamo registrazione, non archiviamo codice analizzato e non vendiamo dati personali.",
        privacySection1Title: "1. Base giuridica e conformità",
        privacySection1Intro: "Il trattamento dei dati da parte di GitTree rispetta:",
        privacySection1List: '<li class="list-item">Legge Generale sulla Protezione dei Dati – LGPD (Legge nº 13.709/2018)</li><li class="list-item">Regolamento Generale sulla Protezione dei Dati dell\'Unione Europea (GDPR)</li><li class="list-item">Politiche di Google AdSense e Google Consent Mode</li>',
        privacySection2Title: "2. Informazioni raccolte",
        privacySection2P1: "GitTree <strong>non raccoglie dati personali sensibili</strong> e <strong>non richiede l\'identificazione dell\'utente</strong>.",
        privacySection2P2: "Gli URL pubblici di repository GitHub possono essere forniti volontariamente per scopi di analisi. Il contenuto analizzato <strong>non viene archiviato, indicizzato o ridistribuito</strong>.",
        privacySection2P3: "In modo automatico, possono essere raccolte informazioni tecniche e anonime, tra cui:",
        privacySection2List: '<li class="list-item">Indirizzo IP anonimizzato</li><li class="list-item">Tipo di browser e sistema operativo</li><li class="list-item">Pagine visitate e tempo di navigazione</li><li class="list-item">Posizione approssimativa (paese o regione)</li>',
        privacySection3Title: "3. Cookie, pubblicità e CMP",
        privacySection3P1: "Utilizziamo cookie e tecnologie simili per garantire il funzionamento, la sicurezza, l\'analisi statistica e la monetizzazione del sito.",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – analisi dell\'utilizzo e delle prestazioni</li><li class="list-item"><strong>Google AdSense</strong> – visualizzazione di annunci</li>',
        privacySection3P2: "Google e i suoi partner possono utilizzare cookie per la personalizzazione o la misurazione degli annunci, in base al consenso dell\'utente.",
        privacySection3P3: "La gestione del consenso viene effettuata tramite una <strong>Piattaforma di Gestione del Consenso (CMP)</strong>, che consente di accettare, rifiutare o personalizzare l\'uso dei cookie, in conformità con LGPD e GDPR.",
        privacySection4Title: "4. Condivisione dei dati",
        privacySection4P1: "GitTree <strong>non commercializza dati personali</strong>.",
        privacySection4P2: "Le informazioni tecniche anonime possono essere condivise con fornitori di servizi strettamente per:",
        privacySection4List: '<li class="list-item">Misurazione del pubblico</li><li class="list-item">Visualizzazione di pubblicità</li><li class="list-item">Sicurezza e prevenzione degli abusi</li>',
        privacySection4P3: "Questi terzi elaborano i dati in conformità con le proprie politiche e obblighi legali.",
        privacySection5Title: "5. Diritti dell\'utente",
        privacySection5P1: "Ai sensi della normativa applicabile, hai il diritto di:",
        privacySection5List: '<li class="list-item">Richiedere conferma sul trattamento dei dati</li><li class="list-item">Revocare i consensi in qualsiasi momento</li><li class="list-item">Richiedere informazioni aggiuntive su cookie e tracciamento</li>',
        privacySection5P2: "Poiché non manteniamo database personali identificabili, le richieste si applicano generalmente a servizi di terze parti.",
        privacySection6Title: "6. Aggiornamenti di questa informativa",
        privacySection6P1: "Questa Informativa sulla Privacy può essere modificata in qualsiasi momento per adeguamento legale o miglioramenti tecnici. La versione vigente sarà sempre disponibile in questa pagina. Versione attuale: Gennaio 2026",
        privacySection7Title: "7. Contatti",
        privacySection7P1: "Per domande relative alla privacy e alla protezione dei dati:",
        ...
        termsIntroNotice: "GitTree è uno strumento di analisi ausiliario. Non sostituisce la revisione umana, l\'audit tecnico o il giudizio professionale.",
        termsSection1Title: "1. Descrizione del servizio",
        termsSection1P1: "GitTree è uno strumento online che esegue analisi automatizzate di repository pubblici GitHub, con l\'obiettivo di offrire visualizzazioni, metriche e interpretazioni ausiliarie sul codice sorgente.",
        termsSection1P2: "Le analisi vengono generate in modo automatizzato e <strong>non costituiscono garanzia di qualità, sicurezza o conformità</strong> del codice analizzato.",
        termsSection2Title: "2. Uso accettabile",
        termsSection2P1: "Utilizzando GitTree, ti impegni a:",
        termsSection2List: '<li class="list-item">Fornire solo URL di repository pubblici o di tua proprietà</li><li class="list-item">Utilizzare lo strumento per scopi leciti ed etici</li><li class="list-item">Non tentare di sfruttare vulnerabilità, sovraccaricare o compromettere il servizio</li>',
        termsSection2P2: "È vietato l\'uso dello strumento per attività illegali, abusive o che violino i diritti di terzi.",
        termsSection3Title: "3. Proprietà intellettuale",
        termsSection3P1: "GitTree non rivendica alcun diritto sul codice analizzato.",
        termsSection3P2: "Tutto il contenuto originale della piattaforma (interfaccia, identità visiva, testi e logica del servizio) è protetto da diritti d\'autore e appartiene ai rispettivi titolari.",
        termsSection3P3: "L\'utilizzo del servizio non concede all\'utente alcun diritto di sfruttamento commerciale della piattaforma.",
        termsSection4Title: "4. Limitazione di responsabilità",
        termsSection4P1: 'GitTree è fornito <strong>"così com\'è"</strong>, senza garanzie espresse o implicite.',
        termsSection4P2: "Non siamo responsabili per:",
        termsSection4List: '<li class="list-item">Errori, omissioni o imprecisioni nelle analisi</li><li class="list-item">Decisioni prese in base alle informazioni presentate</li><li class="list-item">Danni diretti o indiretti derivanti dall\'uso dello strumento</li>',
        termsSection4P3: "L\'utente è l\'unico responsabile della verifica, interpretazione e applicazione dei risultati ottenuti.",
        termsSection5Title: "5. Disponibilità del servizio",
        termsSection5P1: "GitTree può essere modificato, sospeso o interrotto, totalmente o parzialmente, in qualsiasi momento senza preavviso.",
        termsSection5P2: "Non garantiamo disponibilità continua o priva di errori.",
        termsSection6Title: "6. Privacy e dati",
        termsSection6P1: 'Il trattamento dei dati segue quanto stabilito dall\'<a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">Informativa sulla Privacy</a>, parte integrante di questi Termini.',
        termsSection6P2: "Utilizzando il sito, dichiari di essere a conoscenza dell\'uso di cookie, strumenti di analisi e pubblicità, come indicato nella politica corrispondente.",
        termsSection7Title: "7. Modifiche ai termini",
        termsSection7P1: "Questi Termini di Utilizzo possono essere modificati in qualsiasi momento per adeguamento legale o evoluzione del servizio.",
        termsSection7P2: "La continuazione dell\'utilizzo dopo le modifiche implica l\'accettazione della versione aggiornata.",
        termsSection8Title: "8. Contatti",
        termsSection8P1: "Per domande su questi Termini di Utilizzo, contattaci:",
    ...
    ja: {
        ...
        statusClipboardError: "クリップボードにアクセスできません",
        confirmClearCache: "すべてのキャッシュをクリアしますか？",
        statusNoTree: "コピーするツリーがありません",
        statusEmptyTree: "空のツリー",
        statusCopyError: "コピーエラー",
        statusCorrecting: "修正先：",
        statusFetching: "取得中：",
        statusProcessingItems: "{n}個のアイテムを処理中...",
        ...
        privacyIntroNotice: "要約：登録は不要で、解析されたコードは保存せず、個人データは販売しません。",
        privacySection1Title: "1. 法的根拠とコンプライアンス",
        privacySection1Intro: "GitTreeによるデータ処理は以下に準拠しています：",
        privacySection1List: '<li class="list-item">個人データ保護一般法 – LGPD（法律第13.709/2018号）</li><li class="list-item">欧州連合の一般データ保護規則（GDPR）</li><li class="list-item">Google AdSenseおよびGoogle Consent Modeのポリシー</li>',
        privacySection2Title: "2. 収集される情報",
        privacySection2P1: "GitTreeは<strong>機密個人データを収集せず</strong>、<strong>ユーザーの識別も要求しません</strong>。",
        privacySection2P2: "GitHubリポジトリの公開URLは、分析目的で任意に提供できます。解析されたコンテンツは<strong>保存、インデックス、または再配布されません</strong>。",
        privacySection2P3: "自動的に、以下を含む匿名の技術情報が収集される場合があります：",
        privacySection2List: '<li class="list-item">匿名化されたIPアドレス</li><li class="list-item">ブラウザの種類とオペレーティングシステム</li><li class="list-item">アクセスしたページと閲覧時間</li><li class="list-item">おおよその位置情報（国または地域）</li>',
        privacySection3Title: "3. Cookie、広告、CMP",
        privacySection3P1: "サイトの運営、セキュリティ、統計分析、収益化を確保するため、Cookieおよび類似技術を使用しています。",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – 使用状況とパフォーマンス分析</li><li class="list-item"><strong>Google AdSense</strong> – 広告表示</li>',
        privacySection3P2: "Googleとそのパートナーは、ユーザーの同意に基づき、広告のパーソナライズや測定のためにCookieを使用する場合があります。",
        privacySection3P3: "同意管理は<strong>同意管理プラットフォーム（CMP）</strong>を通じて行われ、LGPDおよびGDPRに準拠してCookieの使用を承認、拒否、またはカスタマイズできます。",
        privacySection4Title: "4. データの共有",
        privacySection4P1: "GitTreeは<strong>個人データを販売しません</strong>。",
        privacySection4P2: "匿名の技術情報は、以下の目的のみでサービスプロバイダーと共有される場合があります：",
        privacySection4List: '<li class="list-item">視聴者測定</li><li class="list-item">広告表示</li><li class="list-item">セキュリティと不正利用防止</li>',
        privacySection4P3: "これらの第三者は、各自のポリシーと法的義務に従ってデータを処理します。",
        privacySection5Title: "5. ユーザーの権利",
        privacySection5P1: "適用法に基づき、あなたには以下の権利があります：",
        privacySection5List: '<li class="list-item">データ処理に関する確認を要求する</li><li class="list-item">いつでも同意を撤回する</li><li class="list-item">Cookieとトラッキングに関する追加情報を要求する</li>',
        privacySection5P2: "識別可能な個人データベースを保持していないため、リクエストは通常第三者サービスに適用されます。",
        privacySection6Title: "6. ポリシーの更新",
        privacySection6P1: "このプライバシーポリシーは、法的適合または技術的改善のためにいつでも変更される場合があります。現行バージョンは常にこのページで確認できます。現在のバージョン：2026年1月",
        privacySection7Title: "7. お問い合わせ",
        privacySection7P1: "プライバシーとデータ保護に関するご質問は：",
        ...
        termsIntroNotice: "GitTreeは補助的な分析ツールです。人間によるレビュー、技術的な監査、または専門的な判断の代替にはなりません。",
        termsSection1Title: "1. サービスの説明",
        termsSection1P1: "GitTreeは、ソースコードに関する視覚化、メトリクス、補助的な解釈を提供することを目的として、GitHubの公開リポジトリの自動分析を行うオンラインツールです。",
        termsSection1P2: "分析は自動的に生成されており、解析されたコードの品質、セキュリティ、適合性の<strong>保証にはなりません</strong>。",
        termsSection2Title: "2. 許容される使用方法",
        termsSection2P1: "GitTreeを使用する際、あなたは以下に同意します：",
        termsSection2List: '<li class="list-item">公開リポジトリまたは自分が所有するリポジトリのURLのみを提供する</li><li class="list-item">適法かつ倫理的な目的でツールを使用する</li><li class="list-item">脆弱性の悪用、過負荷、またはサービスの侵害を試みない</li>',
        termsSection2P2: "違法、不正、または第三者の権利を侵害する活動のためのツール使用は禁止されています。",
        termsSection3Title: "3. 知的財産",
        termsSection3P1: "GitTreeは解析されたコードに対するいかなる権利も主張しません。",
        termsSection3P2: "プラットフォームのすべての独自コンテンツ（インターフェース、ビジュアルアイデンティティ、テキスト、サービスロジック）は著作権によって保護され、各権利者に帰属します。",
        termsSection3P3: "サービスの使用により、ユーザーにはプラットフォームの商業的利用に関するいかなる権利も付与されません。",
        termsSection4Title: "4. 責任の制限",
        termsSection4P1: 'GitTreeは<strong>「現状のまま」</strong>提供され、明示的または黙示的な保証はありません。',
        termsSection4P2: "以下について責任を負いません：",
        termsSection4List: '<li class="list-item">分析におけるエラー、省略、または不正確さ</li><li class="list-item">提示された情報に基づく決定</li><li class="list-item">ツールの使用から生じる直接的または間接的な損害</li>',
        termsSection4P3: "ユーザーは、得られた結果の確認、解釈、適用について単独で責任を負います。",
        termsSection5Title: "5. サービスの可用性",
        termsSection5P1: "GitTreeは、予告なしに、全部または一部について、いつでも変更、停止、または中止される場合があります。",
        termsSection5P2: "継続的またはエラーのない可用性を保証しません。",
        termsSection6Title: "6. プライバシーとデータ",
        termsSection6P1: 'データの処理は、本規約の不可分の一部である<a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">プライバシーポリシー</a>の規定に従います。',
        termsSection6P2: "サイトを使用することにより、対応するポリシーに記載されているように、Cookie、分析ツール、広告の使用を認識していることを宣言します。",
        termsSection7Title: "7. 規約の変更",
        termsSection7P1: "本利用規約は、法的適合またはサービスの進化のためにいつでも変更される場合があります。",
        termsSection7P2: "変更後の継続使用は、更新されたバージョンへの同意を意味します。",
        termsSection8Title: "8. お問い合わせ",
        termsSection8P1: "本利用規約についてのご質問は：",
    ...
    ko: {
        ...
        statusClipboardError: "클립보드에 접근할 수 없습니다",
        confirmClearCache: "모든 캐시를 지우시겠습니까?",
        statusNoTree: "복사할 트리가 없습니다",
        statusEmptyTree: "빈 트리",
        statusCopyError: "복사 오류",
        statusCorrecting: "다음으로 수정 중:",
        statusFetching: "가져오는 중:",
        statusProcessingItems: "{n}개 항목 처리 중...",
        ...
        privacyIntroNotice: "요약: 회원가입이 필요 없으며, 분석된 코드를 저장하지 않고, 개인 데이터를 판매하지 않습니다.",
        privacySection1Title: "1. 법적 근거 및 준수",
        privacySection1Intro: "GitTree의 데이터 처리는 다음을 준수합니다:",
        privacySection1List: '<li class="list-item">일반 데이터 보호법 – LGPD (법률 제13.709/2018호)</li><li class="list-item">유럽 연합 일반 데이터 보호 규정 (GDPR)</li><li class="list-item">Google AdSense 및 Google Consent Mode 정책</li>',
        privacySection2Title: "2. 수집되는 정보",
        privacySection2P1: "GitTree는 <strong>민감한 개인 데이터를 수집하지 않으며</strong>, <strong>사용자 식별을 요구하지 않습니다</strong>.",
        privacySection2P2: "GitHub 저장소의 공개 URL은 분석 목적으로 자발적으로 제공될 수 있습니다. 분석된 내용은 <strong>저장, 인덱싱 또는 재배포되지 않습니다</strong>.",
        privacySection2P3: "자동으로 다음을 포함한 익명의 기술 정보가 수집될 수 있습니다:",
        privacySection2List: '<li class="list-item">익명화된 IP 주소</li><li class="list-item">브라우저 유형 및 운영 체제</li><li class="list-item">방문한 페이지 및 탐색 시간</li><li class="list-item">대략적인 위치 (국가 또는 지역)</li>',
        privacySection3Title: "3. 쿠키, 광고 및 CMP",
        privacySection3P1: "사이트의 운영, 보안, 통계 분석 및 수익화를 보장하기 위해 쿠키 및 유사 기술을 사용합니다.",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – 사용 및 성능 분석</li><li class="list-item"><strong>Google AdSense</strong> – 광고 표시</li>',
        privacySection3P2: "Google과 그 파트너는 사용자 동의에 따라 광고 개인화 또는 측정을 위해 쿠키를 사용할 수 있습니다.",
        privacySection3P3: "동의 관리는 <strong>동의 관리 플랫폼(CMP)</strong>을 통해 이루어지며, LGPD 및 GDPR에 따라 쿠키 사용을 수락, 거부 또는 사용자 지정할 수 있습니다.",
        privacySection4Title: "4. 데이터 공유",
        privacySection4P1: "GitTree는 <strong>개인 데이터를 판매하지 않습니다</strong>.",
        privacySection4P2: "익명의 기술 정보는 다음 목적으로만 서비스 제공업체와 공유될 수 있습니다:",
        privacySection4List: '<li class="list-item">청중 측정</li><li class="list-item">광고 표시</li><li class="list-item">보안 및 남용 방지</li>',
        privacySection4P3: "이러한 제3자는 자체 정책 및 법적 의무에 따라 데이터를 처리합니다.",
        privacySection5Title: "5. 사용자 권리",
        privacySection5P1: "적용 법률에 따라 귀하는 다음 권리를 갖습니다:",
        privacySection5List: '<li class="list-item">데이터 처리에 관한 확인 요청</li><li class="list-item">언제든지 동의 철회</li><li class="list-item">쿠키 및 추적에 관한 추가 정보 요청</li>',
        privacySection5P2: "식별 가능한 개인 데이터베이스를 유지하지 않으므로 요청은 일반적으로 제3자 서비스에 적용됩니다.",
        privacySection6Title: "6. 정책 업데이트",
        privacySection6P1: "이 개인정보 보호정책은 법적 준수 또는 기술적 개선을 위해 언제든지 변경될 수 있습니다. 현재 버전은 항상 이 페이지에서 확인할 수 있습니다. 현재 버전: 2026년 1월",
        privacySection7Title: "7. 연락처",
        privacySection7P1: "개인 정보 및 데이터 보호에 관한 문의사항:",
        ...
        termsIntroNotice: "GitTree는 보조 분석 도구입니다. 인간의 검토, 기술 감사 또는 전문적 판단을 대체하지 않습니다.",
        termsSection1Title: "1. 서비스 설명",
        termsSection1P1: "GitTree는 소스 코드에 대한 시각화, 메트릭 및 보조 해석을 제공하기 위해 GitHub 공개 저장소의 자동 분석을 수행하는 온라인 도구입니다.",
        termsSection1P2: "분석은 자동으로 생성되며, 분석된 코드의 품질, 보안 또는 적합성을 <strong>보증하지 않습니다</strong>.",
        termsSection2Title: "2. 허용 가능한 사용",
        termsSection2P1: "GitTree 사용 시 귀하는 다음에 동의합니다:",
        termsSection2List: '<li class="list-item">공개 저장소 또는 귀하 소유 저장소의 URL만 제공</li><li class="list-item">합법적이고 윤리적인 목적으로만 도구 사용</li><li class="list-item">취약점 악용, 과부하 또는 서비스 침해 시도 금지</li>',
        termsSection2P2: "불법적이거나 남용적이거나 제3자의 권리를 침해하는 활동에 도구를 사용하는 것은 금지됩니다.",
        termsSection3Title: "3. 지적 재산권",
        termsSection3P1: "GitTree는 분석된 코드에 대한 어떠한 권리도 주장하지 않습니다.",
        termsSection3P2: "플랫폼의 모든 독창적인 콘텐츠(인터페이스, 시각적 정체성, 텍스트 및 서비스 로직)는 저작권으로 보호되며 각 소유자에게 귀속됩니다.",
        termsSection3P3: "서비스 사용으로 사용자에게 플랫폼의 상업적 활용에 대한 어떠한 권리도 부여되지 않습니다.",
        termsSection4Title: "4. 책임의 제한",
        termsSection4P1: 'GitTree는 명시적 또는 묵시적 보증 없이 <strong>"있는 그대로"</strong> 제공됩니다.',
        termsSection4P2: "다음에 대해 책임지지 않습니다:",
        termsSection4List: '<li class="list-item">분석의 오류, 누락 또는 부정확성</li><li class="list-item">제시된 정보를 기반으로 한 결정</li><li class="list-item">도구 사용으로 인한 직접적 또는 간접적 손해</li>',
        termsSection4P3: "사용자는 얻은 결과의 검증, 해석 및 적용에 대해 단독으로 책임을 집니다.",
        termsSection5Title: "5. 서비스 가용성",
        termsSection5P1: "GitTree는 사전 통지 없이 언제든지 전체 또는 일부가 변경, 중단 또는 종료될 수 있습니다.",
        termsSection5P2: "지속적이거나 오류 없는 가용성을 보장하지 않습니다.",
        termsSection6Title: "6. 개인 정보 및 데이터",
        termsSection6P1: '데이터 처리는 본 약관의 불가분의 일부인 <a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">개인정보 보호정책</a>의 규정에 따릅니다.',
        termsSection6P2: "사이트를 사용함으로써, 해당 정책에 명시된 바와 같이 쿠키, 분석 도구 및 광고 사용에 대해 인지하고 있음을 선언합니다.",
        termsSection7Title: "7. 약관 변경",
        termsSection7P1: "본 이용약관은 법적 준수 또는 서비스 발전을 위해 언제든지 수정될 수 있습니다.",
        termsSection7P2: "변경 후 지속적인 사용은 업데이트된 버전에 대한 동의를 의미합니다.",
        termsSection8Title: "8. 연락처",
        termsSection8P1: "본 이용약관에 관한 문의사항:",
    ...
    zh: {
        ...
        statusExported: "导出成功！",
        statusClipboardError: "无法访问剪贴板",
        confirmClearCache: "清除所有缓存？",
        statusNoTree: "没有可复制的树",
        statusEmptyTree: "空树",
        statusCopyError: "复制错误",
        statusCorrecting: "正在更正为：",
        statusFetching: "正在获取",
        statusProcessingItems: "正在处理 {n} 个项目...",
        ...
        privacyIntroNotice: "总结：我们不需要注册，不存储已分析的代码，也不出售个人数据。",
        privacySection1Title: "1. 法律依据和合规",
        privacySection1Intro: "GitTree的数据处理遵守：",
        privacySection1List: '<li class="list-item">个人数据保护通用法 – LGPD（第13.709/2018号法律）</li><li class="list-item">欧盟通用数据保护条例（GDPR）</li><li class="list-item">Google AdSense和Google Consent Mode政策</li>',
        privacySection2Title: "2. 收集的信息",
        privacySection2P1: "GitTree<strong>不收集敏感个人数据</strong>，也<strong>不要求用户身份识别</strong>。",
        privacySection2P2: "GitHub存储库的公开URL可以自愿提供用于分析目的。已分析的内容<strong>不会被存储、索引或重新分发</strong>。",
        privacySection2P3: "系统可能自动收集匿名技术信息，包括：",
        privacySection2List: '<li class="list-item">匿名化IP地址</li><li class="list-item">浏览器类型和操作系统</li><li class="list-item">访问的页面和浏览时间</li><li class="list-item">大致位置（国家或地区）</li>',
        privacySection3Title: "3. Cookie、广告和CMP",
        privacySection3P1: "我们使用Cookie和类似技术来保证网站的运营、安全、统计分析和变现。",
        privacySection3List: '<li class="list-item"><strong>Google Analytics</strong> – 使用和性能分析</li><li class="list-item"><strong>Google AdSense</strong> – 广告展示</li>',
        privacySection3P2: "根据用户同意，Google及其合作伙伴可能使用Cookie进行广告个性化或测量。",
        privacySection3P3: "同意管理通过<strong>同意管理平台（CMP）</strong>进行，允许根据LGPD和GDPR的规定接受、拒绝或自定义Cookie的使用。",
        privacySection4Title: "4. 数据共享",
        privacySection4P1: "GitTree<strong>不出售个人数据</strong>。",
        privacySection4P2: "匿名技术信息可能仅用于以下目的与服务提供商共享：",
        privacySection4List: '<li class="list-item">受众测量</li><li class="list-item">广告展示</li><li class="list-item">安全和防止滥用</li>',
        privacySection4P3: "这些第三方根据其自身政策和法律义务处理数据。",
        privacySection5Title: "5. 用户权利",
        privacySection5P1: "根据适用法律，您有权：",
        privacySection5List: '<li class="list-item">请求确认数据处理情况</li><li class="list-item">随时撤回同意</li><li class="list-item">请求有关Cookie和跟踪的更多信息</li>',
        privacySection5P2: "由于我们不维护可识别的个人数据库，请求通常适用于第三方服务。",
        privacySection6Title: "6. 政策更新",
        privacySection6P1: "本隐私政策可能随时因法律合规或技术改进而更改。当前版本将始终在此页面上提供。当前版本：2026年1月",
        privacySection7Title: "7. 联系方式",
        privacySection7P1: "有关隐私和数据保护的问题：",
        ...
        termsIntroNotice: "GitTree是一个辅助分析工具，不能替代人工审查、技术审计或专业判断。",
        termsSection1Title: "1. 服务描述",
        termsSection1P1: "GitTree是一个在线工具，对GitHub公开存储库进行自动分析，旨在提供有关源代码的可视化、指标和辅助解释。",
        termsSection1P2: "分析是自动生成的，<strong>不构成对被分析代码的质量、安全性或合规性的保证</strong>。",
        termsSection2Title: "2. 可接受的使用",
        termsSection2P1: "使用GitTree时，您同意：",
        termsSection2List: '<li class="list-item">仅提供公开存储库或您拥有的存储库的URL</li><li class="list-item">将工具用于合法且合乎道德的目的</li><li class="list-item">不尝试利用漏洞、使服务过载或破坏服务</li>',
        termsSection2P2: "禁止将该工具用于非法、滥用或侵犯第三方权利的活动。",
        termsSection3Title: "3. 知识产权",
        termsSection3P1: "GitTree对被分析的代码不主张任何权利。",
        termsSection3P2: "平台的所有原创内容（界面、视觉标识、文本和服务逻辑）受版权保护，归各自所有者所有。",
        termsSection3P3: "使用该服务不授予用户对平台进行商业利用的任何权利。",
        termsSection4Title: "4. 责任限制",
        termsSection4P1: 'GitTree以<strong>"按原样"</strong>提供，不提供明示或暗示的保证。',
        termsSection4P2: "我们不承担以下责任：",
        termsSection4List: '<li class="list-item">分析中的错误、遗漏或不准确</li><li class="list-item">根据所提供信息做出的决定</li><li class="list-item">因使用该工具而产生的直接或间接损害</li>',
        termsSection4P3: "用户单独负责对所获得结果的验证、解释和应用。",
        termsSection5Title: "5. 服务可用性",
        termsSection5P1: "GitTree可能随时在不事先通知的情况下全部或部分更改、暂停或停止。",
        termsSection5P2: "我们不保证连续或无错误的可用性。",
        termsSection6Title: "6. 隐私和数据",
        termsSection6P1: '数据处理遵循<a href="politica-de-privacidade.html" style="color: #7aa2ff; text-decoration: none;">隐私政策</a>的规定，该政策是本条款的组成部分。',
        termsSection6P2: "通过使用本网站，您声明已了解相应政策中所述的Cookie、分析工具和广告的使用。",
        termsSection7Title: "7. 条款变更",
        termsSection7P1: "本使用条款可能随时因法律合规或服务演进而修改。",
        termsSection7P2: "变更后继续使用意味着接受更新后的版本。",
        termsSection8Title: "8. 联系方式",
        termsSection8P1: "有关本使用条款的问题，请联系：",
