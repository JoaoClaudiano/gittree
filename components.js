            ...
            if (item.type === 'folder') {
                ...
                return React.createElement('div', {
                    ...
                    React.createElement('div', {
                        ...
                        onClick: () => hasChildren && toggleFolder(item.path),
                        onMouseEnter: (e) => {
                        ...
                        React.createElement('i', {
                            ...
                            style: { 
                                color: hasChildren ? '#f59e0b' : '#94a3b8',
                                fontSize: '16px',
                                width: '24px',
                        ...
                        React.createElement('span', {
                            key: 'name',
                            style: {
                                color: hasChildren ? '#f8fafc' : '#94a3b8',
                                fontSize: '15px',
                                fontWeight: '500',
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                React.createElement('span', { key: 'files' }, `📁 ${treeStats.totalFiles} arquivos`),
                React.createElement('span', { key: 'sep1', style: { margin: '0 10px' } }, '•'),
                React.createElement('span', { key: 'folders' }, `📂 ${treeStats.totalFolders} pastas`),
            ...
            React.createElement('div', {
                ...
                files.length > 0 ? 'Clique em pastas para expandir/colapsar' : 'Digite um repositório para começar'
            ])
        ])
    ]);
};
                    ...
                    React.createElement('div', {
                        ...
                        React.createElement('div', {
                            ...
                            React.createElement('div', {
                                ...
                                React.createElement('span', { key: 'lang' }, file.language || 'N/A'),
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                }, (repoInfo.forks || 0).toLocaleString()),
                React.createElement('div', {
                    key: 'label',
                    style: { 
                        color: '#94a3b8',
        ...
        viewMode === 'tree' 
            ? React.createElement('div', {
                ...
                React.createElement(FileTree, {
                    ...
                    repoInfo: repoInfo,
                    onFileClick: (file) => {
                        if (file && file.path && repoInfo && repoInfo.url && repoInfo.default_branch) {
                            window.open(`${repoInfo.url}/blob/${repoInfo.default_branch}/${file.path}`, '_blank');
                        } else {
                            console.warn('Não foi possível abrir o arquivo:', file);
                        }
                    }
                })
            ])
    ...
    return React.createElement('div', { 
        ...
        React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        ...
                        }, 'Visualizador de Estrutura GitHub')
                    ]),
                    React.createElement('p', {
                        key: 'subtitle',
                        style: { 
                    ...
                    }, 'Explore e analise a estrutura de repositórios GitHub')
                ])
            ]),
            ...
            React.createElement('div', {
                ...
                }, 'O GitTree analisa a estrutura de repositórios GitHub, exibindo arquivos em formato de árvore, lista ou gráficos. Os dados são armazenados localmente no seu navegador para acesso rápido.')
            ])
        ]),
